...
//       // Try employee OTP verification if admin failed
//       if (!verified) {
//         try {
//           const response = await axios.post(
//             `${BE_URL}/employeeDataName/verify-otp`,
//             { email, otp: otpValue }
//           );
//           if (response.data.message === "OTP verified successfully") {
//             verified = true;
...
//         }, 2000);
//       } else {
//         setError(apiErrorMsg || "Invalid OTP. Please try again.");
//       }
//     } else {
//       setError("Please enter a 6-digit OTP");
//     }
  ...
  const handleVerify = async () => {
    ...
    if (otpValue.length === 6) {
      ...
      if (!verified) {
        try {
          const response = await axios.post(
            `${BE_URL}/generalManagerDataName/verify-otp`,
            { email, otp: otpValue }
          );
          if (response.data.message === "OTP verified successfully") {
            verified = true;
