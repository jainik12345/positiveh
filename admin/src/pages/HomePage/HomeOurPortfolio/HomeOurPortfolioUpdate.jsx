...
const HomeOurPortfolioUpdate = () => {
  ...
  const [preview, setPreview] = useState(
    rowData.image
      ? `${BE_URL}/Images/HomeImages/HomeOurPortfolio/${rowData.image}`
      : null
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`${BE_URL}/homeOurPortfolio/${rowData.id}`, formData);
      setSuccess(true);
      setTimeout(() => {
        setSuccess(false);
...
export default HomeOurPortfolioUpdate;
