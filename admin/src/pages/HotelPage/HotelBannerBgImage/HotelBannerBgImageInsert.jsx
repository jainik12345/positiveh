...
const HotelBannerBgImageInsert = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`${BE_URL}/hotelBannerBgImage`, formData, {
      ...
      if (res.data.status === "success") {
        ...
        setError("Failed to add background image");
      }
    } catch (err) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Add Hotel Banner Background Image
        </h2>
...
export default HotelBannerBgImageInsert;
