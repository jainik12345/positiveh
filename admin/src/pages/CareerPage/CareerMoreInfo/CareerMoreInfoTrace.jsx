...
const CareerMoreInfoTrace = () => {
  ...
  const fetchTrashedData = async () => {
    try {
      const res = await axios.get(`${BE_URL}/careerMoreInfo/trashed`);
      ...
      console.error("Error fetching trashed career info:", err);
    }
  };

  const handleRestore = async (id) => {
    try {
      await axios.patch(`${BE_URL}/careerMoreInfo/restore/${id}`);
      ...
      console.error("Error restoring career info:", err);
    }
  };
