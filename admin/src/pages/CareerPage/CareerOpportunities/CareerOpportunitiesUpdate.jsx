...
const CareerOpportunitiesUpdate = () => {
  ...
  const [preview, setPreview] = useState(
    rowData.image
      ? `${BE_URL}/Images/CareerImages/CareerOpportunities/${rowData.image}`
      : null
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`${BE_URL}/careerOpportunities/${rowData.id}`, formData);
      setSuccess(true);
      setTimeout(() => {
        setSuccess(false);
...
export default CareerOpportunitiesUpdate;
