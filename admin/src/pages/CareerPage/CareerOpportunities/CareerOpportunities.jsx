...
const CareerOpportunities = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${BE_URL}/careerOpportunities/${id}`);
  ...
  const HandleAddBtn = () => {
    navigate("/career-opportunities/insert");
  };

  const HandleEditBtn = (row) => {
    navigate("/career-opportunities/update", {
      state: { rowData: row },
    });
  };
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-7">
          <Trace onClick={() => navigate("/career-opportunities/trace")} />
          <Add
            text="Add Career Opportunities"
            width="w-[255px]"
