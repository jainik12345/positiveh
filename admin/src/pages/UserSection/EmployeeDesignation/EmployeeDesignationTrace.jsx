...
const EmployeeDesignationTrace = () => {
  ...
  const fetchTrashedData = async () => {
    try {
      const res = await axios.get(`${BE_URL}/employeeDesignation/trashed`);
      ...
      console.error("Error fetching trashed employee designation:", err);
    }
  };

  const handleRestore = async (id) => {
    try {
      await axios.patch(`${BE_URL}/employeeDesignation/restore/${id}`);
...
export default EmployeeDesignationTrace;
