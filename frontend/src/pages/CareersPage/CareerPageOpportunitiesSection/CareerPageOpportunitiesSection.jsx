...
//   <article
//     className="bg-white rounded-2xl shadow-md hover:shadow-2xl transition-shadow duration-300 flex flex-col h-full"
//     aria-label={title}
//   >
//     <div className={`flex items-center justify-center p-8 ${color} rounded-t-2xl`}>
//       {icon}
//     </div>
...
//         <h1 className="font-extrabold text-gray-900 text-3xl md:text-5xl mb-4">
//           Career Opportunities with <span className="text-blue-600">Positive Hospitality</span>
//         </h1>
//         <p className="text-gray-700 font-medium max-w-2xl mx-auto">
//           Discover rewarding career paths in hospitality that focus on providing exceptional, positive experiences for guests and team members alike.
//         </p>
//       </header>
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
