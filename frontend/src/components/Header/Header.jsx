...
//     { Name: "Training", Path: "https://admin.indicabs.biz/" },
//   ];
              ...
              <li key={idx}>
                {item.Path.startsWith("http") ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="py-2 relative px-1 transition-colors duration-300 text-white hover:text-blue-500 font-semibold"
                  >
                    {item.Name}
                  </a>
                ) : (
              ...
              <li key={idx} className="w-full">
                {item.Path.startsWith("http") ? (
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={() => setOpen(false)}
                    className="block py-2 w-full text-white hover:text-blue-500 font-semibold"
                  >
                    {item.Name}
                  </a>
                ) : (
